...
<div class="table_list">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<c:forEach var="obj" items="${pageBean.dataList}">
			...
			<td>
			    <a href="#" onclick="pageEditSingleData('cashManagement.do?actionMethod=edit','queryId','${obj.id}','workspace');">修改</a>&nbsp;&nbsp;
			    <a href="#" onclick="postDataForSingleDelete('cashManagement.do?actionMethod=delete', 'id', '${obj.id}', 'workspace');">删除</a>&nbsp;&nbsp;
			</td>
		    </tr>
		 </c:forEach>
		 </tbody>
...
<script>
	//增加信息
	function editPlan() {
		 getData('cashManagement.do?actionMethod=add','','workspace');
	}
</script>