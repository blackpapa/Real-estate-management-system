...
<form:form modelAttribute="returnCashReport" name="returnCashReport">
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="search_condition">
 ...
 <div class="search_bottom">
  <input type="button" class="button" value="查询" onclick="trimForm('returnCashReport');postDataByFormName('returnCashReport','workspace');" />
  <input type="button" class="button" value="清空" onclick="clearFormById('returnCashReport',1);" />
 </div>
</div>
<div class="table_list">
 ...
 <div class="pager">
  <c:if test="${pageBean!=null}">
		<ct:ajaxCutPage pageBean="${pageBean}" formName="returnCashReport" resultArea="workspace" offerPageSize="20,50,100" isExistForm="true"/>
 </c:if>
 </div>
</form:form>
<script>
